...
import com.t3c.anchel.core.notifications.context.ShareWarnUndownloadedFilesharesEmailContext;
import com.t3c.anchel.core.notifications.dto.MailContact;
import com.t3c.anchel.core.notifications.dto.SEGDocument;
import com.t3c.anchel.core.notifications.dto.ShareGroup;
...
public class ShareWarnUndownloadedFilesharesEmailBuilder extends EmailBuilder {
	...
	protected List<Context> getContextForFakeBuild(Language language) {
		...
		d.addShare(new MailContact("amy.wolsh@t3c.io", "Amy", "Wolsh"), true);
		d.addShare(new MailContact("peter.wilson@t3c.io", "Peter", "Wilson"), true);
		d.addShare(new MailContact("unknown@t3c.io"), true);
		documents.add(d);
		...
		d.addShare(new MailContact("amy.wolsh@t3c.io", "Amy", "Wolsh"), false);
		d.addShare(new MailContact("peter.wilson@t3c.io", "Peter", "Wilson"), false);
		d.addShare(new MailContact("unknown@t3c.io"), false);
		documents.add(d);
