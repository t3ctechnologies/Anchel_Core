...
import com.t3c.anchel.core.notifications.context.GenericUploadRequestEmailContext;
import com.t3c.anchel.core.notifications.dto.Document;
import com.t3c.anchel.core.notifications.dto.MailContact;
import com.t3c.anchel.core.notifications.dto.Request;
...
public abstract class GenericUploadRequestEmailBuilder extends EmailBuilder {
	...
	protected Context newFakeContext(Language language, boolean warnOwner, boolean addRecipient) {
		...
		ctx.setVariable("requestOwner", new MailContact("peter.wilson@t3c.io", "Peter", "Wilson"));
		if (addRecipient) {
			ctx.setVariable("requestRecipient", new MailContact("unknown@t3c.io"));
		}
