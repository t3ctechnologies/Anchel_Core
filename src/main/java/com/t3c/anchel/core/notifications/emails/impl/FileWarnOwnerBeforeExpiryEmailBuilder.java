...
import com.t3c.anchel.core.notifications.context.FileWarnOwnerBeforeExpiryEmailContext;
...
public class FileWarnOwnerBeforeExpiryEmailBuilder extends EmailBuilder {
	...
	protected List<Context> getContextForFakeBuild(Language language) {
		...
		ctx.setVariable("owner", new MailContact("peter.wilson@t3c.io", "Peter", "Wilson"));
