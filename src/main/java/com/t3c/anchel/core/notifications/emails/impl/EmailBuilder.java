...
import com.t3c.anchel.core.exception.TechnicalErrorCode;
import com.t3c.anchel.core.exception.TechnicalException;
import com.t3c.anchel.core.notifications.context.EmailContext;
import com.t3c.anchel.core.notifications.context.FakeBuildEmailContext;
...
import com.t3c.anchel.core.notifications.dto.Variable;
import com.t3c.anchel.core.notifications.emails.IEmailBuilder;
...
public abstract class EmailBuilder implements IEmailBuilder {
	...
	protected final static String MAIL_DTO_PATH = "com.t3c.anchel.core.notifications.dto.";
	...
	protected MailContainerWithRecipient buildMailContainerThymeleaf(MailConfig cfg, MailContentType type, Context ctx,
		...
		try {
			...
			if (emailCtx.getLanguage().equals(Language.FRENCH)) {
				addAttachment(container, "logo.linshare@t3c.io", "/org/linagora/linshare/core/service/email-logo-fr.png");
			} else {
				addAttachment(container, "logo.linshare@t3c.io", "/org/linagora/linshare/core/service/email-logo-en.png");
			}
			addAttachment(container, "logo.libre.and.free@t3c.io", "/org/linagora/linshare/core/service/email-libre-and-free.png");
			addAttachment(container, "logo.arrow@t3c.io", "/org/linagora/linshare/core/service/email-arrow.png");
