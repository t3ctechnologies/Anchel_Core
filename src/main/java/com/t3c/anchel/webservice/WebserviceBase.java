 ...
 */
package com.t3c.anchel.webservice;
...
public class WebserviceBase {
	...
	protected Long getTransfertDuration() {
		...
		if (exchange.containsKey("com.t3c.anchel.webservice.interceptor.start_time")) {
			uploadStartTime = (Long) exchange.get("com.t3c.anchel.webservice.interceptor.start_time");
