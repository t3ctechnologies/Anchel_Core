...
-- Template FOOTER
insert into linshare_mail_templates (parameter_id, template_id, content_html, content_txt, language_id) values (1,1,'<a href="http://t3c.io/" title="LinShare"><strong>LinShare</strong></a> - Open Source secured file sharing application','LinShare - http://t3c.io - Open Source secured file sharing application',0);
insert into linshare_mail_templates (parameter_id, template_id, content_html, content_txt, language_id) values (1,1,'<a href="http://t3c.io/" title="LinShare"><strong>LinShare</strong></a> - Logiciel libre de partage de fichiers sécurisé','LinShare - http://t3c.io - Logiciel libre de partage de fichiers sécurisé',1);
...
-- Template FOOTER
INSERT INTO linshare_mail_templates (parameter_id, template_id, content_html, content_txt, language_id) VALUES (1, 1, E'<a href="http://t3c.io/" title="LinShare"><strong>LinShare</strong></a> - Open Source toepassing voor het beveiligd delen van bestanden', E'LinShare - http://t3c.io - Open Source toepassing voor het beveiligd delen van bestanden', 2);
