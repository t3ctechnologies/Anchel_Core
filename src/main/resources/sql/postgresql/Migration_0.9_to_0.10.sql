...
INSERT INTO linshare_domain_abstract(id, type , identifier, label, enable, template, description, default_role, default_locale, used_space, user_provider_id, domain_policy_id, parent_id, messages_configuration_id) VALUES (1, 0, 'AnchelRootDomain', 'AnchelRootDomain', true, false, 'The root application domain', 3, 'en', 0, null, 1, null, 1);
