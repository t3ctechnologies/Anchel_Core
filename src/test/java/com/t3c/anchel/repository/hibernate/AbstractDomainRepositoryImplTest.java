...
import com.t3c.anchel.core.domain.entities.RootDomain;
...
import com.t3c.anchel.core.repository.LdapConnectionRepository;
...
public class AbstractDomainRepositoryImplTest extends AbstractTransactionalJUnit4SpringContextTests {
	...
	public void testFindSubDomain() throws BusinessException{
		List<String> list = abstractDomainRepository.getAllSubDomainIdentifiers("AnchelRootDomain");
