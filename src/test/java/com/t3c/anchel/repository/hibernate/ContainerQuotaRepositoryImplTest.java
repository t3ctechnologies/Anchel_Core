...
import com.t3c.anchel.core.domain.constants.QuotaType;
...
import com.t3c.anchel.core.repository.hibernate.ContainerQuotaRepositoryImpl;
import com.t3c.anchel.core.repository.hibernate.DomainQuotaRepositoryImpl;
...
public class ContainerQuotaRepositoryImplTest extends AbstractTransactionalJUnit4SpringContextTests {
	...
	public void setUp() {
		...
		datas.loadUsers();
		jane = datas.getUser2();
		inconsistent = userRepository.findByMailAndDomain(LoadingServiceTestDatas.sqlDomain, "inconsistent-user1@t3c.io");
	...
	private void initialChecks() {
		...
		/// AnchelRootDomain, MyDomain, MySubDomain and GuestDomain
