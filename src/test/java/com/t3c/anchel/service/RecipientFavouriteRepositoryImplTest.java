...
import com.t3c.anchel.core.exception.LinShareNotSuchElementException;
...
import com.t3c.anchel.core.repository.hibernate.RecipientFavouriteRepositoryImpl;
...
public class RecipientFavouriteRepositoryImplTest extends AbstractTransactionalJUnit4SpringContextTests{
	...
	public void setUp() throws Exception {
		...
		user1 = new Internal("John","Doe","user1@t3c.io", null);
		user2 = new Internal("Jane","Smith","user2@t3c.io", null);
		user3 = new Internal("Foo","Bar","user3@t3c.io", null); 
