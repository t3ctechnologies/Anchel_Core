...
public class LoadingServiceTestDatas {
	...
	public static String sqlRootDomain = "AnchelRootDomain";
	...
	public LoadingServiceTestDatas(UserRepository<User> userRepository) {
		super();
	...
	public void loadUsers() throws BusinessException {
		...
		user1 = userRepository.findByMail("user1@t3c.io");
		user2 = userRepository.findByMail("user2@t3c.io");
		user3 = userRepository.findByMail("user3@t3c.io");
	}
	...
	public int getAvailableFunctionalitiesForTopDomain2() {
		// three have their activation policy dedicated to the root domain
		// (forbidden or mandatory): -3 : (FUNC1,FUNC2,FUNC3)
		return TOTAL_COUNT_FUNC - 3;
	}

	public int getAlterableFunctionalitiesForTopDomain2() {
		// two have their activation policy set to forbidden , so they can't be
		// active nor configurable : -2 : (FUNC1,FUNC2)
	...
	public int getEditableFunctionalitiesForTopDomain2() {
		...
		// two have their activation policy set to forbidden , so they can't be
		// active nor configurable nor usable : -2 : (FUNC1,FUNC2)
