...
public final class SoapService_SoapServicePort_Client {
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        com.t3c.anchel.webservice.test.soap.DocumentAttachement _addDocumentXop_arg0 = null;
        try {
            com.t3c.anchel.webservice.test.soap.Document _addDocumentXop__return = port.addDocumentXop(_addDocumentXop_arg0);
        ...
        try {
            com.t3c.anchel.webservice.test.soap.SimpleLongValue _getAvailableSize__return = port.getAvailableSize();
        ...
        try {
            java.util.List<com.t3c.anchel.webservice.test.soap.Document> _getDocuments__return = port.getDocuments();
        ...
        try {
            com.t3c.anchel.webservice.test.soap.SimpleLongValue _getUserMaxFileSize__return = port.getUserMaxFileSize();
